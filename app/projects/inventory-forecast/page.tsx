          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2 lg:order-1">
              <div className="prose prose-lg max-w-none">
                  ...
                  <ul className="list-disc list-inside space-y-4 text-gray-300 ml-4">
                    <li>
                      ...
                      <ul className="list-disc list-inside space-y-1 ml-6 mt-2">
                        ...
                        <li>
                          <strong className="text-white">Store Location:</strong> Webstore
                        </li>
                        <li>
                          <strong className="text-white">Pricing Tier:</strong> Discounted
                        </li>
                        <li>
                          <strong className="text-white">Subclass Name:</strong> Dresses
                        </li>
                      </ul>
                    ...
                    <li>
                      <strong className="text-white">
                        Used the 2024 sales history to calculate the average sales for different periods:
                      </strong>
                      <ul className="list-disc list-inside space-y-1 ml-6 mt-2">
                    ...
                    <li>
                      <strong className="text-white">
                        Computed the weighted average to forecast January sales using the formula:
                      </strong>
                      <div className="bg-gray-800 p-4 rounded-lg mt-2 font-mono text-orange-400">
                        Weighted Average = (0.6 × Average during Lenient) + (0.3 × Average during Moderate) + (0.1 ×
                        Average during Peak)
                      </div>
                      <span className="block mt-2">
                        As shown, I reduced the weight of peak months to 10% for a more accurate forecast.
                      </span>
                    </li>
                ...
                {/* Replenishment Planning Template Image */}
                <div className="mb-8">
                  ...
                  <p className="text-sm text-gray-400 mt-2 text-center">
                    Comprehensive replenishment planning template showing inventory allocation and sourcing decisions
                  </p>
                </div>
                ...
                <div className="mb-8">
                  <Button
                    ...
                    onClick={() => window.open("https://1drv.ms/x/s!AirSZr7mKLStdf1lRCI5WRX_w9I?e=VgA5XU", "_blank")}
                  >
                    <ExternalLink className="w-4 h-4 mr-2" />
                    View Excel Workbook Online
                  </Button>

                  <p className="text-gray-300 leading-relaxed mb-6">You can access the forecasting template below:</p>
                </div>
                ...
                <div className="mb-8">
                  <div className="relative aspect-video rounded-lg overflow-hidden">
                    <Image
                      src="/images/inventory-forecast.png"
                      alt="Inventory Forecasting Model Screenshot"
                      fill
                      className="object-cover"
                    />
                  </div>
